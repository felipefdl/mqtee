...
Requirements: Xcode 26.0+, Rust 1.85.0+, `just`, `cargo-bundle-licenses`.
...
Integration tests (local broker):
...
- User-facing strings: update `mqtee/Localizable.xcstrings` when needed (see root `AGENTS.md`).
